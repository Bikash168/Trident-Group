...
export default function AIResearchInternshipApplication() {
    ...
    <Layout>
      <section className="py-16 bg-white" id="internship-application">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl text-[#316b9e] font-bold text-center mb-4">Apply for AI Research Internship</h2>
          <p className="text-lg text-center text-gray-700 mb-8">
            Please fill out the form below to apply for the AI Research Internship.
          </p>
